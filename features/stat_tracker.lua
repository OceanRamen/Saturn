...
function Card:update(dt)
  ...
  if G.STAGE == G.STAGES.RUN and self:has_counter() then
    ...
    if self.ability.name == "Bootstraps" then
      self:set_counter(
        nil,
        self.ability.extra.mult * math.floor(
            (G.GAME.dollars + (G.GAME.dollar_buffer or 0)) / self.ability.extra.dollars
          )
      )
    end
  end
...
function Card:init_counter(args)
  ...
  if args.counter_type then
    self.counter = {
      ...
      highscore_value = (
        (args.highscore_type and args.highscore_value) or (args.highscore_type == "x_mult_scale" and 1)
      ) or 0,
      highscore_old_value = (
        (args.highscore_type and args.highscore_old_value) or (args.highscore_type == "x_mult_scale" and 1)
      ) or 0,
      ...
      highscore_value_colour = (args.highscore_type and highscore_type_table[args.highscore_type][2])
  ...
  if self.ability.set == "Joker" and self.area == G.jokers then
    ...
    if self:has_counter() and S.SETTINGS.modules.stattrack.enabled then
      ...
      elseif
        ...
        and S.SETTINGS.modules.stattrack.features.joker_tracking.groups["miscellaneous"]
        and not checked
      then
        show_counter = true
      end
                            ...
                            nodes = {
                              {
                                ...
                                nodes = self.counter.highscore_type == "x mult scale"
                                    and {
                                      {
                                        n = G.UIT.C,
                                        config = {
                                  ...
                                  or {
                                    {
                                      ...
                                      config = {
                                        ...
                                        colour = self.counter.highscore_value_colour ~= G.C.UI.TEXT_LIGHT
                                            and self.counter.highscore_value_colour
                                          or G.C.UI.TEXT_DARK,
                                      },
                                    },
                                  },
                        ...
                        nodes = {
                          {
                            ...
                            config = {
                              padding = 0.1,
                              r = 0.1,
                              text = self.counter.counter_value_num > 1 and self.counter.counter_text .. "s"
                            ...
                            nodes = {
                              {
                                ...
                                nodes = self.counter.counter_type == "x mult"
                                    and {
                                      {
                                        n = G.UIT.C,
                                        config = {
                                            ...
                                            text = "+"
                                              .. (
                                                self.ability.name == "Walkie Talkie"
                                                  and (self.counter.counter_value * 10)
                                                or self.ability.name == "Scholar"
                                                  and (self.counter.counter_value * 20)
                                              ),
                                            colour = G.C.BLUE,
                                          },
                                        },
                                  ...
                                  or not is_obelisk and {
                                    {
                                      ...
                                      config = {
                                        ...
                                        colour = self.counter.counter_value_colour ~= G.C.UI.TEXT_LIGHT
                                            and self.counter.counter_value_colour
                                          or G.C.UI.TEXT_DARK,
                                      },
                                    },
                                  }
                ...
                nodes = {
                  {
                    ...
                    nodes = {
                      ...
                      self.counter.highscore_type == "x mult scale"
                          and {
                            n = G.UIT.C,
                            config = {
                              align = "cm",
                              ...
                              nodes = {
                                {
                                  ...
                                  config = {
                                    ...
                                    text = "+"
                                      .. (
                                        self.ability.name == "Walkie Talkie" and (self.counter.counter_value * 10)
                                        or self.ability.name == "Scholar" and (self.counter.counter_value * 20)
                                      ),
                                    colour = G.C.BLUE,
                                  },
                                },
          ...
          nodes = {
            {
              ...
              config = {
                ...
                colour = self.counter.counter_value_colour ~= G.C.UI.TEXT_LIGHT and self.counter.counter_value_colour
                  or G.C.UI.TEXT_DARK,
              },
            },
          },
          ...
          nodes = {
            {
              ...
              config = {
                ...
                text = self.counter.counter_value_num > 1 and self.counter.counter_text .. "s:"
                  or self.counter.counter_text .. ":",
                scale = self.counter.counter_text_size
                  * (1 - ((1 - obelisk_scale_factor) * (#self.counter.counter_value_text - 1))),
                colour = self.counter.counter_text_colour,
              },
            },
          },
...
function Card:calculate_counters(context)
  ...
  elseif context.end_of_round then
    if context.repetition then
      if context.cardarea == G.hand then
        if self.ability.name == "Mime" and (next(context.card_effects[1]) or #context.card_effects > 1) then
          self:increment_counter(self.ability.extra)
        end
      end
  ...
  elseif context.individual then
    if context.cardarea == G.play then
      ...
      if self.ability.name == "Golden Ticket" and context.other_card.ability.name == "Gold Card" then
        self:increment_counter(self.ability.extra)
      end
      ...
      if
        self.ability.name == "Walkie Talkie"
        and (context.other_card:get_id() == 10 or context.other_card:get_id() == 4)
      then
        self:increment_counter(1)
      end
      if
    ...
    if context.cardarea == G.jokers then
      if context.before then
        ...
        if
          ...
          and (self.ability.type == "" or next(context.poker_hands[self.ability.type]))
        then
        ...
        if
          ...
          and G.GAME.current_round.discards_left == self.ability.extra.d_remaining
        then
          self:increment_counter(self.ability.extra.mult)
        end
        ...
        if
          ...
          and math.floor((G.GAME.dollars + (G.GAME.dollar_buffer or 0)) / self.ability.extra.dollars) >= 1
        then
          self:increment_counter(
            self.ability.extra.mult
              * math.floor((G.GAME.dollars + (G.GAME.dollar_buffer or 0)) / self.ability.extra.dollars)
          )
          self:set_counter(
            nil,
            self.ability.extra.mult
